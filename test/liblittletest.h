...
int gettimeofday(struct timeval* tp, struct timezone* tzp) {
    ...
    if (QueryPerformanceFrequency(&lpFrequency)) {
        ...
        long uptime_ms = (long)
            GetTickCount();  // number of milliseconds that have elapsed since
...
#define AUTORUN_TESTS()                                              \
    ...
    for (__lt_autorun_it__ = littletest::auto_test_vector.begin();   \
         __lt_autorun_it__ != littletest::auto_test_vector.end();    \
         ++__lt_autorun_it__)                                        \
...
#define LT_CREATE_RUNNER(__lt_suite_name__, __lt_runner_name__)                \
    std::cout << "** Initializing Runner \"" << #__lt_runner_name__ << "\" **" \
              << std::endl;                                                    \
...
#define LT_BEGIN_TEST(__lt_suite_name__, __lt_test_name__) \
    struct __lt_test_name__##_class                        \
        : public __lt_suite_name__,                        \
          littletest::test<__lt_test_name__##_class> {     \
...
#define LT_END_AUTO_TEST(__lt_test_name__) LT_END_TEST(__lt_test_name__)
...
#define LT_SIMPLE_OP(__lt_name__, __lt_val__, __lt_file__, __lt_line__, \
                     __lt_mode__)                                       \
    if (!((__lt_val__))) {                                              \
        std::stringstream __lt_ss__;                                    \
        __lt_ss__ << "(" << __lt_file__ << ":" << __lt_line__           \
                  << ") - error in " << "\"" << __lt_name__ << "\"";    \
        LT_SWITCH_MODE(__lt_mode__)                                     \
    }

#define LT_THROW_OP(__lt_name__, __lt_operation__, __lt_file__, __lt_line__, \
                    __lt_mode__)                                             \
    ...
    try {                                                                    \
        ...
        __lt_ss__ << "(" << __lt_file__ << ":" << __lt_line__                \
                  << ") - error in " << "\"" << __lt_name__                  \
                  << "\": no exceptions thown by " << #__lt_operation__;     \
        __lt_thrown__ = true;                                                \
    } catch (...) {                                                          \
    }                                                                        \
    if (__lt_thrown__) LT_SWITCH_MODE(__lt_mode__)

#define LT_NOTHROW_OP(__lt_name__, __lt_operation__, __lt_file__, __lt_line__, \
                      __lt_mode__)                                             \
    try {                                                                      \
        (__lt_operation__);                                                    \
        ...
        __lt_ss__ << "(" << __lt_file__ << ":" << __lt_line__                  \
                  << ") - error in " << "\"" << __lt_name__                    \
                  << "\": exceptions thown by " << #__lt_operation__;          \
        __lt_ss__ << " [ " << e.what() << " ]";                                \
        LT_SWITCH_MODE(__lt_mode__)                                            \
    } catch (...) {                                                            \
        std::stringstream __lt_ss__;                                           \
...
#define LT_COLLEQ_OP(__lt_name__, __lt_first_begin__, __lt_first_end__, \
                     __lt_second_begin__, __lt_file__, __lt_line__,     \
                     __lt_mode__)                                       \
    if (!std::equal((__lt_first_begin__), (__lt_first_end__),           \
                    (__lt_second_begin__))) {                           \
        std::stringstream __lt_ss__;                                    \
        __lt_ss__ << "(" << __lt_file__ << ":" << __lt_line__           \
                  << ") - error in " << "\"" << __lt_name__             \
...
#define LT_COLLNEQ_OP(__lt_name__, __lt_first_begin__, __lt_first_end__, \
                      __lt_second_begin__, __lt_file__, __lt_line__,     \
                      __lt_mode__)                                       \
    if (std::equal((__lt_first_begin__), (__lt_first_end__),             \
                   (__lt_second_begin__))) {                             \
...
#define LT_OP(__lt_name__, __lt_a__, __lt_b__, __lt_file__, __lt_line__, \
              __lt_op__, __lt_mode__)                                    \
    if ((__lt_a__)__lt_op__(__lt_b__)) {                                 \
        std::stringstream __lt_ss__;                                     \
        __lt_ss__ << "(" << __lt_file__ << ":" << __lt_line__            \
                  << ") - error in " << "\"" << __lt_name__              \
                  << "\": " << (__lt_a__) << #__lt_op__ << (__lt_b__);   \
        LT_SWITCH_MODE(__lt_mode__)                                      \
    }
...
#define LT_ADD_SUCCESS(__lt_mode__) \
    if (__lt_mode__) __lt_tr__->add_success();

#define LT_EV(__lt_a__, __lt_b__, __lt_op__, __lt_mode__)              \
    try {                                                              \
        LT_OP(__lt_name__, (__lt_a__), (__lt_b__), __FILE__, __LINE__, \
              __lt_op__, __lt_mode__);                                 \
...
#define LT_SIMPLE_EV(__lt_val__, __lt_mode__)                       \
    try {                                                           \
        LT_SIMPLE_OP(__lt_name__, (__lt_val__), __FILE__, __LINE__, \
                     __lt_mode__);                                  \
        LT_ADD_SUCCESS(__lt_mode__)                                 \
    }                                                               \
    LT_CATCH_ERRORS
...
#define LT_THROW_EV(__lt_operation__, __lt_mode__)                       \
    try {                                                                \
        LT_THROW_OP(__lt_name__, (__lt_operation__), __FILE__, __LINE__, \
                    __lt_mode__);                                        \
        LT_ADD_SUCCESS(__lt_mode__)                                      \
    }                                                                    \
    LT_CATCH_ERRORS
...
#define LT_NOTHROW_EV(__lt_operation__, __lt_mode__)                       \
    try {                                                                  \
        LT_NOTHROW_OP(__lt_name__, (__lt_operation__), __FILE__, __LINE__, \
                      __lt_mode__);                                        \
        LT_ADD_SUCCESS(__lt_mode__)                                        \
    }                                                                      \
    LT_CATCH_ERRORS

#define LT_COLLEQ_EV(__lt_first_begin__, __lt_first_end__,                    \
                     __lt_second_begin__, __lt_mode__)                        \
    try {                                                                     \
        LT_COLLEQ_OP(__lt_name__, (__lt_first_begin__), (__lt_first_end__),   \
                     (__lt_second_begin__), __FILE__, __LINE__, __lt_mode__); \
        LT_ADD_SUCCESS(__lt_mode__)                                           \
    }                                                                         \
    LT_CATCH_ERRORS

#define LT_COLLNEQ_EV(__lt_first_begin__, __lt_first_end__,                    \
                      __lt_second_begin__, __lt_mode__)                        \
    try {                                                                      \
        LT_COLLNEQ_OP(__lt_name__, (__lt_first_begin__), (__lt_first_end__),   \
                      (__lt_second_begin__), __FILE__, __LINE__, __lt_mode__); \
        LT_ADD_SUCCESS(__lt_mode__)                                            \
    }                                                                          \
    LT_CATCH_ERRORS
...
#define LT_WARN_NOTHROW(__lt_operation__) \
    LT_NOTHROW_EV((__lt_operation__), WARN)
#define LT_WARN_COLLECTIONS_EQ(__lt_first_begin__, __lt_first_end__, \
                               __lt_second_begin__)                  \
    LT_COLLEQ_EV((__lt_first_begin__), (__lt_first_end__),           \
                 (__lt_second_begin__), WARN)
#define LT_WARN_COLLECTIONS_NEQ(__lt_first_begin__, __lt_first_end__, \
                                __lt_second_begin__)                  \
    LT_COLLNEQ_EV((__lt_first_begin__), (__lt_first_end__),           \
                  (__lt_second_begin__), WARN)
...
#define LT_CHECK_NEQ(__lt_a__, __lt_b__) \
    LT_EV((__lt_a__), (__lt_b__), ==, CHECK)
...
#define LT_CHECK_NOTHROW(__lt_operation__) \
    LT_NOTHROW_EV((__lt_operation__), CHECK)
#define LT_CHECK_COLLECTIONS_EQ(__lt_first_begin__, __lt_first_end__, \
                                __lt_second_begin__)                  \
    LT_COLLEQ_EV((__lt_first_begin__), (__lt_first_end__),            \
                 (__lt_second_begin__), CHECK)
#define LT_CHECK_COLLECTIONS_NEQ(__lt_first_begin__, __lt_first_end__, \
                                 __lt_second_begin__)                  \
    LT_COLLNEQ_EV((__lt_first_begin__), (__lt_first_end__),            \
                  (__lt_second_begin__), CHECK)

#define LT_ASSERT(__lt_val__) LT_SIMPLE_EV((__lt_val__), ASSERT)
#define LT_ASSERT_EQ(__lt_a__, __lt_b__) \
    LT_EV((__lt_a__), (__lt_b__), !=, ASSERT)
#define LT_ASSERT_NEQ(__lt_a__, __lt_b__) \
    LT_EV((__lt_a__), (__lt_b__), ==, ASSERT)
#define LT_ASSERT_GT(__lt_a__, __lt_b__) \
    LT_EV((__lt_a__), (__lt_b__), <=, ASSERT)
#define LT_ASSERT_GTE(__lt_a__, __lt_b__) \
    LT_EV((__lt_a__), (__lt_b__), <, ASSERT)
#define LT_ASSERT_LT(__lt_a__, __lt_b__) \
    LT_EV((__lt_a__), (__lt_b__), >=, ASSERT)
#define LT_ASSERT_LTE(__lt_a__, __lt_b__) \
    LT_EV((__lt_a__), (__lt_b__), >, ASSERT)
#define LT_ASSERT_THROW(__lt_operation__) \
    LT_THROW_EV((__lt_operation__), ASSERT)
#define LT_ASSERT_NOTHROW(__lt_operation__) \
    LT_NOTHROW_EV((__lt_operation__), ASSERT)
#define LT_ASSERT_COLLECTIONS_EQ(__lt_first_begin__, __lt_first_end__, \
                                 __lt_second_begin__)                  \
    LT_COLLEQ_EV((__lt_first_begin__), (__lt_first_end__),             \
                 (__lt_second_begin__), ASSERT)
#define LT_ASSERT_COLLECTIONS_NEQ(__lt_first_begin__, __lt_first_end__, \
                                  __lt_second_begin__)                  \
    LT_COLLNEQ_EV((__lt_first_begin__), (__lt_first_end__),             \
                  (__lt_second_begin__), ASSERT)

#define LT_FAIL(__lt_message__)                                      \
    std::cout << "[ASSERT FAILURE] (" << __FILE__ << ":" << __LINE__ \
              << ") - error in " << "\"" << (__lt_name__)            \
              << "\": " << (__lt_message__) << std::endl;            \
    __lt_tr__->add_failure();                                        \
...
struct check_unattended : public std::exception {
    check_unattended(const std::string& message) : message(message) {}
...
struct assert_unattended : public std::exception {
    assert_unattended(const std::string& message) : message(message) {}
...
struct warn_unattended : public std::exception {
    warn_unattended(const std::string& message) : message(message) {}
...
class suite {
   public:
    void suite_set_up() { static_cast<suite_impl*>(this)->set_up(); }

    void suite_tear_down() { static_cast<suite_impl*>(this)->tear_down(); }
...
class test_runner {
   public:
    ...
    test_runner& run(test_impl* t) {
        std::cout << "Running test (" << test_counter << "): " << t->__lt_name__
                  << std::endl;
    ...
    void clear_runner() {
        ...
        success_counter = 0;
        failures_counter = 0;
        good_time_total = 0.0, total_set_up_time = 0.0;
        total_tear_down_time = 0.0;
        total_time = 0.0;
    }
    ...
    int operator()() {
        ...
        std::cout << (failures_counter + success_counter) << " checks"
                  << std::endl;
        ...
        std::cout << "Total time spent in tests: " << good_time_total << " ms"
                  << std::endl;
        std::cout << "Average set up time: "
                  << (total_set_up_time / test_counter) << " ms" << std::endl;
        std::cout << "Average tear down time: "
                  << (total_tear_down_time / test_counter) << " ms"
                  << std::endl;
    ...
    void add_failure() { failures_counter++; }

    void add_success() { success_counter++; }
    ...
    void add_good_time(double t) { good_time_total += t; }

    void add_set_up_time(double t) { total_set_up_time += t; }

    void add_tear_down_time(double t) { total_tear_down_time += t; }

    void add_total_time(double t) { total_time += t; }

    operator int() { return failures_counter; }

    int get_test_number() { return test_counter; }

    int get_successes() { return success_counter; }

    int get_failures() { return failures_counter; }

    double get_test_time() { return good_time_total; }
...
class test : public test_base {
    virtual void run_test(test_runner* tr) {
        double set_up_duration = 0.0, tear_down_duration = 0.0,
               test_duration = 0.0;
        ...
        try {
            ...
            std::cout << "[FAILURE] Exception during "
                      << static_cast<test_impl*>(this)->__lt_name__ << " set up"
                      << std::endl;
        ...
        try {
            ...
            std::cout << "[FAILURE] Exception during "
                      << static_cast<test_impl*>(this)->__lt_name__ << " run"
                      << std::endl;
            std::cout << e.what() << std::endl;
            if (tr->last_checkpoint_line != -1)
                std::cout << "Last checkpoint in " << tr->last_checkpoint_file
                          << ":" << tr->last_checkpoint_line << std::endl;
            tr->add_failure();
        } catch (...) {
            std::cout << "[FAILURE] Exception during "
                      << static_cast<test_impl*>(this)->__lt_name__ << " run"
        ...
        std::cout << "- Time spent during \""
                  << static_cast<test_impl*>(this)->__lt_name__
